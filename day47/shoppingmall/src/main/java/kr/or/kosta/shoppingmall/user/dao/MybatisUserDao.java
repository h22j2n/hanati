...
public class MybatisUserDao implements UserDao {
	...
	public User read(String id) throws Exception {
		...
		User user = sqlSession.selectOne(NAMESPACE + "selectUserbyId", id);
		sqlSession.close();
		return user;
	}
	...
	public List<User> listAll() throws Exception {
		SqlSession sqlSession = sqlSessionFactory.openSession();
		List<User> list = sqlSession.selectList(NAMESPACE + "selectAll");
		sqlSession.close();
		return list;
	}
	...
	public User certify(String id, String passwd) throws Exception {
		...
		SqlSession sqlSession = sqlSessionFactory.openSession();
		User user = sqlSession.selectOne(NAMESPACE + "selectUserbyIdPw", params);
		sqlSession.close();
		return user;
	}
	...
	public List<User> listByPage(int page, int listSize) throws Exception {
		...
		SqlSession sqlSession = sqlSessionFactory.openSession();
		List<User> list = sqlSession.selectList(NAMESPACE + "selectUserbyPage2", params);
		sqlSession.close();
		return list;
	}
	...
	public List<User> listByPage(int page, int listSize, String searchType, String searchValue) throws Exception {
		...
		SqlSession sqlSession = sqlSessionFactory.openSession();
		List<User> list = sqlSession.selectList(NAMESPACE + "selectUserbyPage3", params);
		sqlSession.close();
		return list;
	}
	...
	public int countBySearch(String searchType, String searchValue) throws Exception {
		...
		params.put("searchValue", searchValue);
		SqlSession sqlSession = sqlSessionFactory.openSession();
		int count = sqlSession.selectOne(NAMESPACE + "selectCountbySearch", params);
		sqlSession.close();
		return count;
	}
