...
for(Message message : list){
 ...
 if(message.getHitcount().equals("0")){// 조회안한 쪽지가 있을 시
	 check = true;
 }}
}}
%>
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
      ...
      <div class="navbar-collapse collapse navbar-right">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="/board.jsp">BULLETIN BOARD</a></li>
               <%
 ...
 %>
             ...
             <% if(check){// 조회안한 쪽지가 있을시 %>
           <li><img src="/img/alarm.png" style="margin-top:10px;"></li>
  <%}%>
        </ul>
      </div>
    </div>
