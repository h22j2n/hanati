...
<body>
  ...
  <%-- 탑메뉴 시작 --%>
  <jsp:include page="/include/top/boardtopnav.jsp"></jsp:include>
  <%-- 탑메뉴 끝 --%>


  <%-- 내용 시작 --%>
  <jsp:include page="/include/content/boardcontent.jsp"></jsp:include>
  <%-- 내용 끝 --%>


<%-- 사이드 시작 --%>
 <jsp:include page="/include/content/side.jsp"></jsp:include>
<%-- 사이드 끝 --%>
