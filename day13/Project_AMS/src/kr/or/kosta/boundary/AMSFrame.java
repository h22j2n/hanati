...
public class AMSFrame extends Frame {
	...
	public void init() {
		...
		try {
			...
			MinusAccount minusAccount1 = new MinusAccount("8888-1111-2222", "조희진", 1111, 10000, 1000000);
			MinusAccount minusAccount2 = new MinusAccount("9999-1111-2222", "조대출", 1111, 100000, 10000000);
			manager.add(minusAccount1);
	...
	public void startLine() {
		...
		mainPanel.accountListTA.append(
				"---------------------------------------------------------------------------------------" + "\n");
		mainPanel.accountListTA.append(String.format("%5s%30s%20s%15s%20s", "계좌종류","계좌번호","예금주명","현재잔액","대출금액")+"\n");
		mainPanel.accountListTA.append(
				"=======================================================================================" + "\n");
	}
